...
const mockedSimpleValidate = async (request, userName, password) => {
...
module.exports = [
  { 
    ...
    name: 'simple',
    scheme: 'basic',
    options: { validate: mockedSimpleValidate },
  },
  {
    name: 'jwt',
    scheme: 'jwt',
    options: {
      ...
      cookieKey: 'jwttoken', // need a custom name for the cookie because the google stategy uses a cookie with the name of 'token'
    },
  },  
];
