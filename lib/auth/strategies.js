...
module.exports = [
  { 
    ...
    options: {
      ...
      // TODO can this read the redirectUrl we are setting in loginGoogle.js?
      location: function(req) { return req['redirectUrl'] || 'https://pscu-demo-stage.herokuapp.com/restricted'},
    },
  }, {
    name: 'jwt',
    scheme: 'jwt',
